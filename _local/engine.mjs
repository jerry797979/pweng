...
export const KEYWORDS = [
  ...
  { slug: "adult-video-english", ko: "성인화상영어" },
  { slug: "kids-video-english", ko: "어린이화상영어" },
  { slug: "adult-conversation", ko: "성인영어회화" },
  { slug: "native-video-english", ko: "원어민화상영어" },
  { slug: "elementary-video-english", ko: "초등화상영어" },
  { slug: "one-on-one-conversation", ko: "일대일영어회화" },
  { slug: "conversation-study", ko: "영어회화공부" },
  { slug: "travel-conversation", ko: "여행영어회화" },
  { slug: "conversation-study-group", ko: "영어회화스터디" },
  { slug: "daily-conversation", ko: "생활영어회화" },
  { slug: "basic-conversation", ko: "기본영어회화" },
  { slug: "daily-english", ko: "생활영어" },
  { slug: "phone-conversation", ko: "전화영어회화" },
  { slug: "english-speaking", ko: "영어스피킹" },
  { slug: "native-conversation", ko: "원어민영어회화" },
  { slug: "worker-conversation", ko: "직장인영어회화" },
  { slug: "video-english-recommend", ko: "화상영어추천" },
  { slug: "adult-study", ko: "성인영어공부" },
  { slug: "video-conversation", ko: "화상영어회화" },
  { slug: "beginner-conversation", ko: "왕초보영어회화" },
  { slug: "learn-basic-english", ko: "기초영어배우기" },
  { slug: "self-study-conversation", ko: "영어회화독학" },
  { slug: "english-study", ko: "영어공부" },
  { slug: "self-study-english", ko: "영어공부혼자하기" },
  { slug: "ai-conversation", ko: "AI영어회화" },
  { slug: "english-lecture", ko: "영어인강" },
  { slug: "phone-english-recommend", ko: "전화영어추천" },
  { slug: "video-english-site", ko: "화상영어사이트" },
  { slug: "conversation-recommend", ko: "영어회화추천" },
  { slug: "dawn-english", ko: "새벽영어" },
  { slug: "group-english", ko: "그룹영어" },
  { slug: "toddler-english", ko: "유아영어" },
  { slug: "high-conversation", ko: "고등영어회화" },
  { slug: "business-conversation", ko: "비즈니스영어회화" },
  { slug: "elementary-english", ko: "초등영어" },
  { slug: "teen-english", ko: "중고등영어" },
];
