...
// .wrangler/tmp/pages-7l4tJY/bundledWorker-0.15439719206574343.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var SITE = "https://guide.pweng.net";
var KEYWORDS = [
...
var provBySlug = new Map(PROVINCES.map(([ps, pk, cities]) => [ps, { slug: ps, ko: pk, cities }]));
var kwBySlug = new Map(KEYWORDS.map((k) => [k.slug, k]));
function getProvince(pslug) {
  return provBySlug.get(pslug) || null;
}
__name(getProvince, "getProvince");
__name2(getProvince, "getProvince");
function getCity(prov, cslug) {
  if (!prov) return null;
  const c = prov.cities.find(([cs]) => cs === cslug);
  return c ? { slug: c[0], ko: c[1] } : null;
}
__name(getCity, "getCity");
__name2(getCity, "getCity");
function getKeyword(kslug) {
  return kwBySlug.get(kslug) || null;
}
__name(getKeyword, "getKeyword");
__name2(getKeyword, "getKeyword");
var esc = /* @__PURE__ */ __name2((s) => String(s == null ? "" : s).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "esc");
function renderCity(prov, city, keyword) {
  const kw = keyword ? keyword.ko : "\uC601\uC5B4\uD68C\uD654";
  const isHub = !keyword;
  const path = keyword ? `/local/${prov.slug}/${city.slug}/${keyword.slug}/` : `/local/${prov.slug}/${city.slug}/`;
  const url = SITE + path;
  const title = isHub ? `${city.ko} \uC601\uC5B4\uD68C\uD654 \u2014 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uB85C \uD559\uC6D0 \uC5C6\uC774 \uC2DC\uC791\uD558\uAE30` : `${city.ko} ${kw} \u2014 \uD559\uC6D0 \uB300\uC2E0 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uB85C \uC2DC\uC791\uD558\uB294 \uBC95`;
  const desc = `${prov.ko} ${city.ko}\uC5D0\uC11C ${kw}\uB97C \uCC3E\uACE0 \uC788\uB2E4\uBA74, \uD559\uC6D0\uAE4C\uC9C0 \uC624\uAC00\uB294 \uC774\uB3D9\xB7\uC2DC\uAC04 \uBD80\uB2F4 \uC5C6\uC774 \uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C 100% \uACE0\uC815 \uC804\uB2F4 \uAC15\uC0AC\uC640 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uB85C \uB9E4\uC77C \uC774\uC5B4\uAC08 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uD30C\uC6CC\uC789\uAE00\uB9AC\uC26C\uB294 \uD68C\uB2F9 \uC57D 6,270\uC6D0(\uC8FC5\uD68C \uAE30\uC900)\uC785\uB2C8\uB2E4.`;
  ...
  const oneLine = `${esc(city.ko)}\uC5D0\uC11C ${esc(kw)}\uB97C \uCC3E\uACE0 \uC788\uB2E4\uBA74, \uBA3C\uC800 \uC774\uB3D9 \uC2DC\uAC04\uACFC \uACE0\uC815\uB41C \uC218\uC5C5 \uC2DC\uAC04\uD45C\uB97C \uACE0\uB824\uD574\uC57C \uD569\uB2C8\uB2E4. \uAC70\uC810\uAE4C\uC9C0 \uC624\uAC00\uB294 \uBD80\uB2F4 \uC5C6\uC774 <span class="hl">\uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C \uB9E4\uC77C \uAC19\uC740 \uC2DC\uAC04</span>\uC5D0 \uC774\uC5B4\uAC00\uACE0 \uC2F6\uB2E4\uBA74, \uC9C0\uC5ED \uC81C\uC57D\uC774 \uC5C6\uB294 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uAC00 \uD604\uC2E4\uC801\uC778 \uB300\uC548\uC785\uB2C8\uB2E4. <span class="hl">100% \uACE0\uC815 \uC804\uB2F4 \uAC15\uC0AC</span>\uC640 1:1\uB85C, \uC8FC5\uD68C \uAE30\uC900 <span class="hl">\uD68C\uB2F9 \uC57D 6,270\uC6D0</span>\uC5D0 ${esc(city.ko)} \uC5B4\uB514\uC11C\uB4E0 \uC2DC\uC791\uD560 \uC218 \uC788\uB294 \uD30C\uC6CC\uC789\uAE00\uB9AC\uC26C\uB97C \uCD94\uCC9C\uD569\uB2C8\uB2E4.`;
  const faq1q = `${city.ko}\uC5D0 \uC0AC\uB294\uB370 \uC601\uC5B4\uD68C\uD654 \uD559\uC6D0\uC774 \uBA40\uC5B4\uC694. \uC5B4\uB5BB\uAC8C \uD558\uC8E0?`;
  const faq1a = `\uD559\uC6D0\uAE4C\uC9C0 \uC624\uAC00\uB294 \uC2DC\uAC04\uC774 \uBD80\uB2F4\uC774\uB77C\uBA74 \uC9C0\uC5ED \uC81C\uC57D\uC774 \uC5C6\uB294 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uAC00 \uB300\uC548\uC785\uB2C8\uB2E4. ${city.ko} \uC5B4\uB514\uC11C\uB4E0 \uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C 100% \uACE0\uC815 \uC804\uB2F4 \uAC15\uC0AC\uC640 \uB9E4\uC77C \uAC19\uC740 \uC2DC\uAC04\uC5D0 1:1 \uC218\uC5C5\uC744 \uC774\uC5B4\uAC08 \uC218 \uC788\uACE0, \uC8FC5\uD68C \uAE30\uC900 \uD68C\uB2F9 \uC57D 6,270\uC6D0\uC73C\uB85C \uBD80\uB2F4 \uC5C6\uC774 \uBC18\uBCF5\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.`;
  return page({
    title,
    desc,
    ogTitle,
    ogDesc: `${city.ko} \uC5B4\uB514\uC11C\uB4E0 \uC774\uB3D9 0\uBD84\uC73C\uB85C \uB9E4\uC77C \uC774\uC5B4\uAC00\uB294 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4.`,
    url,
    heroTag: `${esc(city.ko)} ${esc(kw)} \uAC00\uC774\uB4DC`,
    h1: `${esc(city.ko)}\uC5D0\uC11C ${esc(kw)}<br><span class="u">\uC5B4\uB5BB\uAC8C \uC2DC\uC791\uD560\uAE4C?${UNDERLINE}</span>`,
    sub: `${esc(city.ko)}\uC5D0\uC11C \uD559\uC6D0\uAE4C\uC9C0 \uC624\uAC00\uB294 \uBD80\uB2F4 \uC5C6\uC774, \uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C \uB9E4\uC77C \uC774\uC5B4\uAC00\uB294 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uB97C \uBE44\uAD50\uD574 \uBCF4\uC138\uC694.`,
    oneLine,
...
__name(renderCity, "renderCity");
__name2(renderCity, "renderCity");
function renderProvinceHub(prov) {
  ...
  const title = `${prov.ko} \uC601\uC5B4\uD68C\uD654 \u2014 \uC2DC\xB7\uAD70\xB7\uAD6C\uBCC4 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4 \uAC00\uC774\uB4DC`;
  const desc = `${prov.ko} \uC804 \uC9C0\uC5ED\uC5D0\uC11C \uD559\uC6D0 \uC5C6\uC774 \uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C \uC2DC\uC791\uD558\uB294 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4. \uC2DC\xB7\uAD70\xB7\uAD6C\uBCC4 \uC548\uB0B4\uC640 \uD68C\uB2F9 \uC57D 6,270\uC6D0 \uD30C\uC6CC\uC789\uAE00\uB9AC\uC26C \uC815\uBCF4\uB97C \uD655\uC778\uD558\uC138\uC694.`;
  return page({
    title,
    desc,
    ogTitle: `${prov.ko} \uC601\uC5B4\uD68C\uD654 \uC9C0\uC5ED\uBCC4 \uC548\uB0B4`,
    ogDesc: desc,
    url,
    heroTag: `${esc(prov.ko)} \uC601\uC5B4\uD68C\uD654`,
    h1: `${esc(prov.ko)} \uC601\uC5B4\uD68C\uD654<br><span class="u">\uC6B0\uB9AC \uB3D9\uB124\uB294?${UNDERLINE}</span>`,
    sub: `${esc(prov.ko)} \uC2DC\xB7\uAD70\xB7\uAD6C \uC5B4\uB514\uC11C\uB4E0 \uC774\uB3D9 \uBD80\uB2F4 \uC5C6\uC774 \uB9E4\uC77C \uC774\uC5B4\uAC00\uB294 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4.`,
    oneLine: `${esc(prov.ko)} \uC5B4\uB514\uC5D0 \uC0B4\uB4E0 \uD559\uC6D0\uAE4C\uC9C0 \uC624\uAC08 \uD544\uC694 \uC5C6\uC774 <span class="hl">\uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C 100% \uACE0\uC815 \uC804\uB2F4 \uAC15\uC0AC</span>\uC640 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uB85C \uB9E4\uC77C \uC774\uC5B4\uAC08 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC8FC5\uD68C \uAE30\uC900 <span class="hl">\uD68C\uB2F9 \uC57D 6,270\uC6D0</span>. \uC544\uB798\uC5D0\uC11C \uC6B0\uB9AC \uC9C0\uC5ED\uC744 \uC120\uD0DD\uD558\uC138\uC694.`,
    compareH2: `${esc(prov.ko)}, \uC5B4\uB5A4 \uBC29\uC2DD\uC774 \uB9DE\uC744\uAE4C?`,
    cityKo: esc(prov.ko),
    provKo: esc(prov.ko),
    nbTitle: `${esc(prov.ko)} \uC2DC\xB7\uAD70\xB7\uAD6C \uC120\uD0DD`,
    nb: cityLinks,
    kwLinks: "",
    faq1q: `${prov.ko}\uC5D0\uC11C \uC601\uC5B4\uD68C\uD654, \uD559\uC6D0\uC774 \uBA40\uBA74 \uC5B4\uB5BB\uAC8C \uD558\uB098\uC694?`,
    faq1a: `${prov.ko} \uC5B4\uB514\uC11C\uB4E0 \uC9C0\uC5ED \uC81C\uC57D \uC5C6\uB294 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uB85C \uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C 100% \uACE0\uC815 \uC804\uB2F4 \uAC15\uC0AC\uC640 \uB9E4\uC77C 1:1 \uC218\uC5C5\uC744 \uC774\uC5B4\uAC08 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC8FC5\uD68C \uAE30\uC900 \uD68C\uB2F9 \uC57D 6,270\uC6D0\uC785\uB2C8\uB2E4.`
  });
}
__name(renderProvinceHub, "renderProvinceHub");
__name2(renderProvinceHub, "renderProvinceHub");
var UNDERLINE = `<svg viewBox="0 0 240 16" fill="none" aria-hidden="true"><path d="M3 11c46-8 150-9 234-4" stroke="var(--mint)" stroke-width="6" stroke-linecap="round"/></svg>`;
function renderNationalHub() {
  const provLinks = PROVINCES.map(([ps, pk]) => `<a class="nb" href="/local/${ps}/">${esc(pk)} \uC601\uC5B4\uD68C\uD654</a>`).join("");
  const desc = "\uC804\uAD6D \uC5B4\uB514\uC11C\uB4E0 \uD559\uC6D0 \uC5C6\uC774 \uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C \uC2DC\uC791\uD558\uB294 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4. \uC2DC\xB7\uB3C4\uBCC4 \uC601\uC5B4\uD68C\uD654 \uC548\uB0B4\uC640 \uD68C\uB2F9 \uC57D 6,270\uC6D0 \uD30C\uC6CC\uC789\uAE00\uB9AC\uC26C \uC815\uBCF4\uB97C \uD655\uC778\uD558\uC138\uC694.";
  return page({
    title: "\uC804\uAD6D \uC9C0\uC5ED\uBCC4 \uC601\uC5B4\uD68C\uD654 \u2014 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4 \uC548\uB0B4",
    desc,
    ogTitle: "\uC804\uAD6D \uC9C0\uC5ED\uBCC4 \uC601\uC5B4\uD68C\uD654 \uC548\uB0B4",
    ogDesc: desc,
    url: `${SITE}/local/`,
    heroTag: "\uC804\uAD6D \uC601\uC5B4\uD68C\uD654",
    h1: `\uC6B0\uB9AC \uC9C0\uC5ED \uC601\uC5B4\uD68C\uD654<br><span class="u">\uC5B4\uB514\uC11C \uC2DC\uC791\uD560\uAE4C?${UNDERLINE}</span>`,
    sub: "\uC804\uAD6D \uC5B4\uB514\uC11C\uB4E0 \uC774\uB3D9 \uBD80\uB2F4 \uC5C6\uC774 \uB9E4\uC77C \uC774\uC5B4\uAC00\uB294 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4.",
    oneLine: `\uC804\uAD6D \uC5B4\uB514\uC5D0 \uC0B4\uB4E0 \uD559\uC6D0\uAE4C\uC9C0 \uC624\uAC08 \uD544\uC694 \uC5C6\uC774 <span class="hl">\uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C 100% \uACE0\uC815 \uC804\uB2F4 \uAC15\uC0AC</span>\uC640 1:1 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uB85C \uB9E4\uC77C \uC774\uC5B4\uAC08 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC8FC5\uD68C \uAE30\uC900 <span class="hl">\uD68C\uB2F9 \uC57D 6,270\uC6D0</span>. \uC544\uB798\uC5D0\uC11C \uC6B0\uB9AC \uC9C0\uC5ED\uC744 \uC120\uD0DD\uD558\uC138\uC694.`,
    compareH2: "\uC804\uAD6D \uC5B4\uB514\uC11C\uB4E0 \uC601\uC5B4\uD68C\uD654, \uC5B4\uB5A4 \uBC29\uC2DD\uC774 \uB9DE\uC744\uAE4C?",
    cityKo: "\uC6B0\uB9AC \uC9C0\uC5ED",
    provKo: "\uC804\uAD6D",
    nbTitle: "\uC9C0\uC5ED(\uB3C4) \uC120\uD0DD",
    nb: provLinks,
    ...
    faq1a: "\uC9C0\uC5ED \uC81C\uC57D\uC774 \uC5C6\uB294 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4\uB77C\uBA74 \uC804\uAD6D \uC5B4\uB514\uC11C\uB4E0 \uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C 100% \uACE0\uC815 \uC804\uB2F4 \uAC15\uC0AC\uC640 \uB9E4\uC77C 1:1 \uC218\uC5C5\uC744 \uC774\uC5B4\uAC08 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC8FC5\uD68C \uAE30\uC900 \uD68C\uB2F9 \uC57D 6,270\uC6D0\uC785\uB2C8\uB2E4."
  });
}
__name(renderNationalHub, "renderNationalHub");
__name2(renderNationalHub, "renderNationalHub");
function page(d) {
...
<div class="grid">
<article class="card"><span class="ptag">\uC624\uD504\uB77C\uC778 \uD559\uC6D0</span><h3 style="margin-top:12px">\uC9C0\uC5ED \uD559\uC6D0\xB7\uC2A4\uD130\uB514</h3><p>\uB300\uBA74 \uC218\uC5C5\uC758 \uC7A5\uC810\uC774 \uC788\uC9C0\uB9CC ${d.cityKo} \uB0B4 \uAC70\uC810\uAE4C\uC9C0 \uC624\uAC00\uB294 \uC774\uB3D9\xB7\uC2DC\uAC04, \uACE0\uC815\uB41C \uC218\uC5C5 \uC2DC\uAC04\uD45C\uB97C \uB9DE\uCDB0\uC57C \uD569\uB2C8\uB2E4.</p></article>
<article class="card"><span class="ptag">\uC571\xB7\uC790\uC728\uD615</span><h3 style="margin-top:12px">AI \uC571\xB7\uC790\uC720 \uC608\uC57D\uD615</h3><p>\uD63C\uC790 \uC5F0\uC2B5\uD558\uAC70\uB098 \uC6D0\uD558\uB294 \uC2DC\uAC04\uC5D0 \uC608\uC57D\uD558\uAE30 \uC88B\uC9C0\uB9CC, \uAC15\uC0AC\uAC00 \uB9E4\uBC88 \uBC14\uB00C\uC5B4 \uB0B4 \uC2E4\uB825\xB7\uC131\uD5A5\uC744 \uAFB8\uC900\uD788 \uD30C\uC545\uD558\uAE30 \uC5B4\uB835\uC2B5\uB2C8\uB2E4.</p></article>
<article class="card pe"><span class="ptag">\uD30C\uC6CC\uC789\uAE00\uB9AC\uC26C</span><h3 style="margin-top:12px">1:1 \uACE0\uC815 \uC804\uB2F4 \uC804\uD654\xB7\uD654\uC0C1\uC601\uC5B4</h3><p>${d.cityKo} \uC5B4\uB514\uC11C\uB4E0 \uC9D1\xB7\uD68C\uC0AC\uC5D0\uC11C 100% \uACE0\uC815 \uC804\uB2F4 \uAC15\uC0AC\uC640 \uB9E4\uC77C \uAC19\uC740 \uC2DC\uAC04\uC5D0 1:1, \uD68C\uB2F9 \uC57D 6,270\uC6D0.</p></article>
</div></div></section>
...
<div class="grid"><article class="card pe"><span class="ptag">100% \uACE0\uC815\uC81C</span><h3 style="margin-top:12px">\uBC14\uB00C\uC9C0 \uC54A\uB294 \uC804\uB2F4 \uAC15\uC0AC</h3><p>4\uB2E8\uACC4 \uAC80\uC99D\uC744 \uAC70\uCE5C \uC804\uBB38 \uAC15\uC0AC\uAC00 100% \uACE0\uC815\uB418\uC5B4 \uB0B4 \uC2E4\uB825\uACFC \uC131\uD5A5\uC744 \uC644\uBCBD\uD558\uAC8C \uD30C\uC545\uD558\uACE0 \uC9C0\uC18D\uC801\uC73C\uB85C \uB04C\uC5B4\uC90D\uB2C8\uB2E4.</p></article><article class="card pe"><span class="ptag">\uC9C1\uC811 \uC120\uD0DD</span><h3 style="margin-top:12px">\uB9DE\uCDA4 \uC218\uC5C5 \uC694\uCCAD</h3><p>\uC790\uAE30\uC18C\uAC1C \uC0DD\uB7B5, \uC989\uC2DC \uBB38\uBC95 \uAD50\uC815 \uB4F1 \uC6D0\uD558\uB294 \uC218\uC5C5 \uBC29\uC2DD\uC744 \uC9C1\uC811 \uC120\uD0DD\uD558\uBA74 \uB2F4\uB2F9 \uAC15\uC0AC\uC5D0\uAC8C \uADF8\uB300\uB85C \uBC18\uC601\uB429\uB2C8\uB2E4.</p></article><article class="card pe"><span class="ptag">\uD569\uB9AC\uC801 \uAC00\uACA9</span><h3 style="margin-top:12px">\uD68C\uB2F9 \uC57D 6,270\uC6D0</h3><p>\uC8FC5\uD68C \uC6D4 125,400\uC6D0\uC73C\uB85C \uC804\uD654\xB7\uD654\uC0C1 \uAD6C\uBD84 \uC5C6\uC774 1:1 \uB9DE\uCDA4 \uC218\uC5C5\uACFC \uC218\uC5C5 \uD6C4 \uCE74\uCE74\uC624\uD1A1 \uD53C\uB4DC\uBC31\uAE4C\uC9C0 \uBB34\uB8CC \uC81C\uACF5.</p></article></div></div></section>
...
<p class="cta-note">100% \uBB34\uB8CC \xB7 \uAC15\uC81C \uACB0\uC81C \uC5C6\uC74C \xB7 30\uCD08\uBA74 \uC644\uB8CC</p></div></div></section>
</main>
...
\uC0AC\uC774\uD2B8\uBA85: \uD30C\uC6CC\uC789\uAE00\uB9AC\uC26C &nbsp;\uB300\uD45C\uC774\uC0AC \uC804\uC0C1\uD604<br>\uC0AC\uC5C5\uC790\uB4F1\uB85D\uBC88\uD638: 217-81-44736 &nbsp;\uD1B5\uC2E0\uD310\uB9E4\uC2E0\uACE0\uBC88\uD638: 2014-\uC11C\uC6B8\uB3C4\uBD09-0233\uD638<br>\xA9 2026 \uD30C\uC6CC\uC789\uAE00\uB9AC\uC26C. All rights reserved.</p></div></footer>
...
__name(allLocalUrls, "allLocalUrls");
__name2(allLocalUrls, "allLocalUrls");
...
var worker_default = {
  async fetch(request, env) {
    ...
    if (path === "/sitemap-local.xml") {
      ...
      const body = '<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n' + allLocalUrls().map((u) => `  <url><loc>${u}</loc><lastmod>${today}</lastmod></url>`).join("\n") + "\n</urlset>\n";
...
function notFound() {
  return `<!DOCTYPE html><html lang="ko"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>\uD398\uC774\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4 \xB7 \uD30C\uC6CC\uC789\uAE00\uB9AC\uC26C</title><style>body{font-family:system-ui,"Pretendard",sans-serif;display:flex;min-height:100vh;align-items:center;justify-content:center;margin:0;background:#f8fafc;color:#16121f;text-align:center}a{color:#6d4aff;font-weight:700}</style></head><body><div><h1 style="font-size:22px">\uD398\uC774\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC5B4\uC694</h1><p style="color:#64748b">\uC694\uCCAD\uD558\uC2E0 \uC9C0\uC5ED\xB7\uC8FC\uC81C \uD398\uC774\uC9C0\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.</p><p style="margin-top:18px"><a href="/local/">\uC804\uAD6D \uC9C0\uC5ED \uC548\uB0B4 \uBCF4\uAE30</a> \xB7 <a href="/">\uD648\uC73C\uB85C</a></p></div></body></html>`;
}
...
// .wrangler/tmp/bundle-mdplCt/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-mdplCt/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.15439719206574343.js.map
